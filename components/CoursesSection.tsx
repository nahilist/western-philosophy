...
export default function CoursesSection() {
  ...
  const filterTabs: FilterTab[] = useMemo(
    () => [
      { id: "all", label: "ALL THINKERS", count: PHILOSOPHER_COURSES.length },
      { id: "antiquity", label: "CLASSICAL ANTIQUITY", count: 3 },
      { id: "early_modern", label: "RENAISSANCE & MODERN", count: 3 },
      { id: "enlightenment", label: "ENLIGHTENMENT & IDEALISM", count: 3 },
      { id: "contemporary", label: "19TH & 20TH CENTURY", count: 5 },
    ],
    []
  );
        ...
        <div className="text-center mb-12 sm:mb-16 space-y-3">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-[10px] uppercase tracking-[0.4em] text-neutral-400 font-medium">
              Comprehensive Canon • 14 Treatises
            </span>
            <span className="w-8 h-px bg-neutral-800" />
          </div>
